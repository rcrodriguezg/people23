...
public class CoursesController {
	...
	@DeleteMapping(path = "/courses", produces=MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity courseDelete(@RequestParam(name = "id", required = false ) String id ) {
		
		try {
			coursesBO.deleteByCode(id);
